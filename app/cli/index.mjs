export { generateBridge, verifySymlinkHealth, repairBridgeSymlinks, createRelativeSymlink, detectPackageManager } from "./core/bridge-generator.mjs";
...
export { handleHookCommand } from "./commands/hook.mjs";
