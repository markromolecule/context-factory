...
- **[[docs/guide/subagents-lifecycle|Coding Lifecycle Subagents Guide]]**: How to use, switch, and delegate tasks to specialized lifecycle subagents (BA, PM, DevOps) across your development workflow.
