...
- [[rules/typescript/common/module-and-imports|Module resolution and imports]]
- [[rules/typescript/common/next-react-project-structure|React and Next.js structure]]
- [[rules/typescript/common/runtime-validation|Runtime validation and boundaries]]
- [[rules/typescript/common/type-safety|Strict type safety]]

### Backend

- [[rules/typescript/backend/controllers-and-routes|Controllers and routes]]
- [[rules/typescript/backend/data-access-via-api|API data access]]
- [[rules/typescript/backend/module-architecture|Module architecture]]
- [[rules/typescript/backend/service-layer|Service layer]]

### Database

- [[rules/typescript/database/data-access-via-db|Database data access]]
...
- [[rules/typescript/database/testing-data-access-layer|Data-access testing]]
...
- [[rules/typescript/ui/code-organization|Code organization]]
