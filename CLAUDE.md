...
- MUST: Verify every claim by inspecting repository files before making statements.
- MUST: Run `node scripts/context.mjs lock` and `node scripts/context.mjs doctor` after context updates.
