...
3. For new-system or materially ambiguous work, require a completed `grill-with-docs` discovery record; stop and return to grilling if goals, scenarios, boundaries, or material decisions remain unresolved.
