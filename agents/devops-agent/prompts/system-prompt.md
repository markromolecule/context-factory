...
4. **Release Readiness Verification:** When preparing deployments, execute `workflows/release-readiness.md` and `skills/security/SKILL.md` to ensure all pre-flight checks pass with verified evidence.
